...
int main()
{
	...
	strcpy(stu[0].student_id,"220953428");
	strcpy(stu[1].student_id,"220953438");
	...
	strcpy(stu[0].fname,"RITIKA");
	strcpy(stu[1].fname,"ANNA");
	strcpy(stu[0].lname,"SALIMATH");
	strcpy(stu[1].lname,"MARTIN");
	...
	strcpy(stu[1].add,"UDUPI");
	strcpy(stu[0].dep,"IT");
	strcpy(stu[1].dep,"CCE");
